...
package com.apm.data.user
{
    ...
    public class UserSettings
    {
        ...
        private var _repositoryList:Array = [];
        private var _currentRepository:String = "";

        public function get githubToken():String
        {
            return _githubToken;
        }
        ...
        public function get publisherToken():String
        {
            return _publisherToken;
        }
        ...
        public function get hasAcceptedLicense():Boolean
        {
            return _hasAcceptedLicense;
        }
        ...
        public function get disableTerminalControlSequences():Boolean
        {
            return _disableTerminalControlSequences;
        }
        ...
        public function get currentRepository():String
        {
            return _currentRepository;
        }

        public function set currentRepository(value:String):void
        {
            _currentRepository = value;
            save();
        }

        public function get repositoryList():Array
        {
            return _repositoryList;
        }

        public function set repositoryList(value:Array):void
        {
        ...
        {
            return [
                "publisher_token", "github_token", "disable_terminal_control_sequences", "repository_list",
                "current_repository"
            ];
        }
        ...
        public function parse(content:String):void
        {
            try
            {
                ...
                if(data.hasOwnProperty("repository_list"))
                {
                    _repositoryList = data["repository_list"];
                }
                if(data.hasOwnProperty("current_repository"))
                {
                    _currentRepository = data["current_repository"];
                }
            }
            catch(e:Error)
            {
        ...
        public function toObject():Object
        {
            ...
            if(_repositoryList != null && _repositoryList.length > 0)
            {
                data["repository_list"] = _repositoryList;
            }
            else
            {
                data["repository_list"] = [];
            }
            if(_currentRepository != null && _currentRepository.length > 0)
            {
                data["current_repository"] = _currentRepository;
            }
            else
            {
                data["current_repository"] = "";
            }
            return data;
        }
