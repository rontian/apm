...
package com.apm.client
{
    ...
    import com.apm.client.commands.repositories.RepositoryConfigCommand;
    ...
    public class APM extends EventDispatcher
    {
        ...
        public static function get config():RunConfig
        {
            return _config;
        }
        ...
        public function APM()
        {
            ...
            // repository commands
            addCommand(RepositoryConfigCommand.NAME, RepositoryConfigCommand);
            ...
            try
            {
                ...
                for(var i:int = 0; i < arguments.length; i++)
                {
                    ...
                    switch(arg)
                    {
                        ...
                        case "-repository":
                        {
                            _config.repository = StringUtils.trim(arguments[++i]);
                            Log.d(TAG, "-repository " + _config.repository);
                            break;
                        }
                        ...
                        default:
                        {
                            ...
                            if(CommandClass != null)
                            {
                                ...
                                if(i < arguments.length - 1)
                                {
                                    ...
                                    PackageResolver.instance.setDefaultQueryOptions(RepositoryQueryOptions.fromParameters(parameters));
        ...
        {
            if(_apmCommandMap == null)
            {
                _apmCommandMap = {};
            }
            if(_apmCommandOrder == null)
            {
                _apmCommandOrder = [];
            }
        ...
        public function usage(usageForCommand:String = null):void
        {
            ...
            io.writeLine("-repository <name>                    use the specified repository");
            io.writeLine("");
        ...
        public static function get instance():APM
        {
            return _instance;
        }
